...
export {auth,app,getAuth, createUserWithEmailAndPassword, signInWithEmailAndPassword, onAuthStateChanged, signOut,storage,ref,listAll,uploadBytes,setDoc,doc,db,addDoc,collection,getDocs,deleteObject }
